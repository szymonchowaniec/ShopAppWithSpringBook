...
import pl.szymonchowaniec.webstore.exception.NoProductsFoundUnderCategoryException;
...
import pl.szymonchowaniec.webstore.validator.ProductValidator;
import pl.szymonchowaniec.webstore.validator.UnitsInStockValidator;
...
public class ProductController {
    ...
    public String processAddNewProductForm(@Valid @ModelAttribute("newProduct")  Product productToBeAdded, ModelMap map, BindingResult result, HttpServletRequest request) {
